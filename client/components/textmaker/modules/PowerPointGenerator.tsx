...
import FileUpload from '@/components/textmaker/FileUpload';
import ProcessingQueue from '@/components/textmaker/ProcessingQueue';
import {
  Presentation,
  Palette,
  Image,
...
import { PowerPointConfig, ProcessingJob, SlideData } from '@/types/textmaker';
          ...
          <Card className="p-6">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                >
                  <div className="grid grid-cols-2 gap-4">
                    <Card className={`p-4 cursor-pointer transition-all ${config.type === 'deep' ? 'ring-2 ring-blue-500 bg-blue-50' : 'hover:bg-gray-50'
                      }`}>
                    ...
                    <Card className={`p-4 cursor-pointer transition-all ${config.type === 'summarized' ? 'ring-2 ring-blue-500 bg-blue-50' : 'hover:bg-gray-50'
                      }`}>
                      <div className="flex items-center space-x-2">
          ...
          <Card className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {themes.map((theme) => (
                <Card
                  key={theme.id}
                  className={`p-4 cursor-pointer transition-all ${config.theme === theme.id
