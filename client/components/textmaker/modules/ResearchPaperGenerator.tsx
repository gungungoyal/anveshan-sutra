...
import { ResearchPaperConfig, Citation, ProcessingJob } from '@/types/textmaker';
              ...
              <div>
                ...
                >
                  <div className="space-y-3">
                    {formats.map((format) => (
                      <Card key={format.id} className={`p-4 cursor-pointer transition-all ${config.format === format.id ? 'ring-2 ring-blue-500 bg-blue-50' : 'hover:bg-gray-50'
                        }`}>
