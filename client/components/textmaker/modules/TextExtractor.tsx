...
import { ExtractedData, ProcessingJob } from '@/types/textmaker';
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Card
                    className={`p-4 cursor-pointer transition-all ${processingMode === 'quick'
                  ...
                  <Card
                    className={`p-4 cursor-pointer transition-all ${processingMode === 'deep'
                        ? 'ring-2 ring-blue-500 bg-blue-50'
                        : 'hover:bg-gray-50'
                      }`}
