...
import { ProcessingJob } from '@/types/textmaker';

export default function TextMakerDashboard() {
          ...
          <Card className="p-6">
            ...
            <div className="space-y-3">
              <Button variant="outline" className="w-full justify-start" asChild>
                <Link to="/tools/text-extraction">
                  <FileText className="w-4 h-4 mr-2" />
                  Extract Text
                </Link>
              </Button>
              <Button variant="outline" className="w-full justify-start" asChild>
                <Link to="/tools/powerpoint">
                  <Presentation className="w-4 h-4 mr-2" />
                  Create Presentation
                </Link>
              </Button>
              <Button variant="outline" className="w-full justify-start" asChild>
                <Link to="/tools/research-paper">
                  <FileImage className="w-4 h-4 mr-2" />
                  Generate Paper
                </Link>
              </Button>
              <Button variant="outline" className="w-full justify-start" asChild>
                <Link to="/tools/bi-dashboard">
